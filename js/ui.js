...
function initSortable() {
        ...
        async function promptClearAllCache() {
            ...
            window._onCacheClearCheckboxChange = (checkbox) => {
                currentSelection[checkbox.value] = checkbox.checked;
            };

            window._toggleAllCacheCheckboxes = (checkAll) => {
                const checkboxes = document.querySelectorAll('.cache-clear-checkbox');
                checkboxes.forEach(cb => {
                    cb.checked = checkAll;
                    currentSelection[cb.value] = checkAll;
                });
            };
