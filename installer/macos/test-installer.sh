...
required_entries=(
  ...
  "Applications/TwitchManager/js/creators.json"
  "Applications/TwitchManager/js/version.js"
  "Applications/TwitchManager/js/locales.js"
  "Applications/TwitchManager/css/twitch_manager.css"
