...
Click the gear icon in the top right corner to access common configuration settings.
...
*Auto commercials are disabled by default. Enable only if needed and verify it does not conflict with Twitch's scheduled ad settings.*
...
Data is stored locally within OBS or browser containers. If settings differ between OBS and your web browser, export a backup from one and restore it in the other.
